...
// export class ActivePlayerCard extends HTMLElement {
//     constructor() {
//         super();
...
//                         <span class="player-card__turn-text" id="dyn-label">Aguardando...</span>
...
//         const themeColor = isMe ? '#f39c12' : '#3498db'; 
...
//     }
// }
// customElements.define("active-player-card", ActivePlayerCard);